...
--List all student(s) who have a the highest mark for course
--	Database Fundamentals. Display the Student fullname and mark

--do I need information from the database to get the information to solve
--	the requested query? (Do I need a subquery?) : YES
-- query that will return the average mark for DMIT1508

Select mark
From Registration
where offeringcode = (Select offeringcode
						From Offering
...
From Registration r inner join Offering o
		r.offeringcode = o.offeringcode
					inner join course c
		o.courseid = c.couserid
Where coursename = 'Database Fundamentals'
